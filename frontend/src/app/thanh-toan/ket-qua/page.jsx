...
function KetQuaThanhToanPageContent() {
...
export default function KetQuaThanhToanPage() {
    return (
        <Suspense fallback={<div className="min-h-screen py-24 flex items-center justify-center bg-gray-50"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div></div>}>
            <KetQuaThanhToanPageContent />
        </Suspense>
    );
}
