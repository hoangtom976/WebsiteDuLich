    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/danh-muc/**", "/api/dia-diem/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_STAFF")
                ...
                .requestMatchers("/api/quan-tri/nguoi-dung/khach-hang").hasAnyAuthority("ROLE_ADMIN", "ROLE_STAFF")
                .requestMatchers("/api/quan-tri/**").hasAuthority("ROLE_ADMIN")
                .requestMatchers("/api/thanh-toan/**").permitAll()
                .requestMatchers("/api/dat-tour/xac-nhan-thanh-toan/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_STAFF")
                ...
                .requestMatchers("/api/chatbot/hoi").permitAll()
                .requestMatchers("/api/chatbot/dong-bo").hasAuthority("ROLE_ADMIN")
